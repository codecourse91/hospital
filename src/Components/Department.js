function Department()
{
    return(
<>
  {/* Mirrored from thememakker.com/templates/oreo/hospital/front/departments.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Feb 2023 05:42:33 GMT */}
  <meta charSet="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta httpEquiv="X-UA-Compatible" content="ie=edge" />
  <title>:: Oreo Hospital :: Department</title>
  ...
  <div className="wrapper">
    ...
    <section id="hero">
      <div className="inner-banner">
        <img src={require("./assets/images/banner-department.jpg")} style={{backgroundRepeat:'no-repeat',maxHeight:'300px',height: '300px',}}></img>
        <div className="container">
          <h3 className="title">
            Oreo Hospital
            <br />
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-4 col-sm-6">
              <div
                className="department-box box-img-cnt"
                data-aos="fade-up"
                data-aos-duration={6000}
              >
                <div className="box-img">
                  <img src={require("./assets/images/department-1.jpg")} alt="" />
                </div>
            ...
            <div className="col-md-4 col-sm-6">
              ...
              >
                <div className="box-img">
                  <img src={require("./assets/images/department-2.jpg")} alt="" />
                </div>
                <div className="box-cnt">
                  <h4>PULMONOLOGY</h4>
                  <p>
            ...
            <div className="col-md-4 col-sm-6">
              ...
              >
                <div className="box-img">
                  <img src={require("./assets/images/department-3.jpg")} alt="" />
                </div>
                <div className="box-cnt">
                  <h4>GYNECOLOGY</h4>
                  <p>
            ...
            <div className="col-md-4 col-sm-6">
              ...
              >
                <div className="box-img">
                  <img src={require("./assets/images/department-4.jpg")} alt="" />
                </div>
                <div className="box-cnt">
                  <h4>NEUROLOGY</h4>
                  <p>
            ...
            <div className="col-md-4 col-sm-6">
              ...
              >
                <div className="box-img">
                  <img src={require("./assets/images/department-5.jpg")} alt="" />
                </div>
                <div className="box-cnt">
                  <h4>UROLOGY</h4>
                  <p>
            ...
            <div className="col-md-4 col-sm-6">
              ...
              >
                <div className="box-img">
                  <img src={require("./assets/images/department-6.jpg")} alt="" />
                </div>
                <div className="box-cnt">
                  <h4>Detal</h4>
                  <p>
  ...
  {/* start screpting */}
  {/* my js */}
  {/* Mirrored from thememakker.com/templates/oreo/hospital/front/departments.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Feb 2023 05:42:34 GMT */}
</>
