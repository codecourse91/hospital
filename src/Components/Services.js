...
function Services()
{
    return(
        <>
  {/* Mirrored from thememakker.com/templates/oreo/hospital/front/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Feb 2023 05:42:32 GMT */}
  <meta charSet="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta httpEquiv="X-UA-Compatible" content="ie=edge" />
  <title>:: Oreo Hospital :: Services</title>
        ...
        <div className="container">
          <div className="row">
            <div className="section-title col-12" data-aos="fade-right">
              <h2>
                <span>Welcome </span>Oreo Hospital
              </h2>
          ...
          <div className="row justify-content-between">
            ...
            <div className="col-md-6 col-sm-12">
              <div className="services-btn-grp d-flex">
                <div className="find-doctor service-btn float-left">
                  <a href="javascript:void(0);" className="text-center">
                    ...
                    <h4>
                      <span>Find Search</span>A Doctor
                    </h4>
                  </a>
                </div>
                <div className="book-appoitntment service-btn float-left">
                  <a href="javascript:void(0);" className="text-center">
                    ...
                    <h4>
                      <span>Book Appointment</span>+ 44 12245 12545
                    </h4>
                  </a>
                </div>
              </div>
      ...
      <div className="department-list services-list">
        <div className="container">
          <div className="row">
            <div className="section-title col-12" data-aos="fade-right">
              <h2>
                <span>Most </span>Popular Services
              </h2>
              <p>Description text here...</p>
            </div>
          </div>
  ...
  {/* start screpting */}
  {/* my js */}
  {/* Mirrored from thememakker.com/templates/oreo/hospital/front/services.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Feb 2023 05:42:33 GMT */}
</>
