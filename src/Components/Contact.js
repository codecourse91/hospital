...
function Contact()
{
    return(
<>
  {/* Mirrored from thememakker.com/templates/oreo/hospital/front/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Feb 2023 05:42:46 GMT */}
  <meta charSet="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta httpEquiv="X-UA-Compatible" content="ie=edge" />
  <title>:: Oreo Hospital :: Contact</title>
  ...
  <div className="wrapper">
              ...
              <ul className="navbar-nav mr-auto col-lg-9">
                ...
                <li className="nav-item dropdown">
                  ...
                  <div className="dropdown-menu">
                    ...
                    <a className="dropdown-item" href="galary">
                      Galary
                    </a>
    ...
    <section id="hero">
      <div
        ...
        <img src={require("./assets/images/banner-contactus.jpg")} style={{backgroundRepeat:'no-repeat',maxHeight:'300px',height: '300px',}}></img>
        <div className="container">
          <h3 className="title">
            Oreo <br />
            <big>
          ...
          <div className="row">
            <div className="col-md-8 col-sm-6">
              <div className="contact-form">
                <div className="row">
                  <div className="col-sm-12 appoitntment-title">
                    Make an Appointment
                  </div>
            ...
            <div className="col-md-4 col-sm-6">
              <div className="contact-sidebar">
                ...
                <ul className="list-unstyled social-icon clearfix">
                  ...
                  <li>
                    <a href="javascript:void(0);">
                      <i className="zmdi zmdi-pinterest-box" />
                    </a>
                  </li>
                  <li>
                    <a href="javascript:void(0);">
        ...
        <div className="container">
          ...
          <div className="row out-partner-logo">
            <div className="col-lg-2 col-md-6 col-sm-6">
              <a href="javascript:void(0);">
                <img src={require("./assets/images/partner-logo-1.png")} alt="" />
              </a>
            </div>
            <div className="col-lg-2 col-md-6 col-sm-6">
              <a href="javascript:void(0);">
                <img src={require("./assets/images/partner-logo-2.png")} alt="" />
              </a>
            </div>
            <div className="col-lg-2 col-md-6 col-sm-6">
              <a href="javascript:void(0);">
                <img src={require("./assets/images/partner-logo-3.png")} alt="" />
              </a>
            </div>
            <div className="col-lg-2 col-md-6 col-sm-6">
              <a href="javascript:void(0);">
                <img src={require("./assets/images/partner-logo-4.png")} alt="" />
              </a>
            </div>
            <div className="col-lg-2 col-md-6 col-sm-6">
              <a href="javascript:void(0);">
            ...
            <div className="col-lg-2 col-md-6 col-sm-6">
              <a href="javascript:void(0);">
                <img src={require("./assets/images/partner-logo-5.png")} alt="" />
              </a>
            </div>
          </div>
        </div>
  ...
  {/* start screpting */}
  {/* my js */}
  {/* Mirrored from thememakker.com/templates/oreo/hospital/front/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Feb 2023 05:42:48 GMT */}
</>
