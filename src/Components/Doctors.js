function Doctors()
{
    return(
<>
  {/* Mirrored from thememakker.com/templates/oreo/hospital/front/doctors.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Feb 2023 05:42:35 GMT */}
  <meta charSet="UTF-8" />
  ...
  <div className="wrapper">
    ...
    <section id="hero">
      <div
        ...
        <img src={require("./assets/images/banner-doctors.jpg")} style={{backgroundRepeat:'no-repeat',maxHeight:'300px',height: '300px',}}></img>
        <div className="container">
          <h3 className="title">
            Our <br />
            <big>
        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-md-4 col-sm-6">
              ...
              >
                <div className="doctor-pic">
                  <img src={require("./assets/images/team-member-05.png")} alt="Dr. John" />
                </div>
                <div className="doctor-info">
                  <h4>
                    Dr. Joseph <span>Dentist</span>
                  </h4>
                  <ul className="clearfix">
                    <li>
                      <a href="javascript:void(0);">
            ...
            <div className="col-md-4 col-sm-6">
              ...
              >
                ...
                <div className="doctor-info">
                  <h4>
                    Dr. Sophie <span>Gynecologist</span>
                  </h4>
                  <ul className="clearfix">
                    <li>
                      <a href="javascript:void(0);">
            ...
            <div className="col-md-4 col-sm-6">
              ...
              >
                <div className="doctor-pic">
                  <img src={require("./assets/images/team-member-07.png")} alt="Dr. Jack" />
                </div>
                <div className="doctor-info">
                  <h4>
                    Dr. William <span>Audiology</span>
                  </h4>
                  <ul className="clearfix">
                    <li>
                      <a href="javascript:void(0);">
            ...
            <div className="col-md-4 col-sm-6">
              ...
              >
                <div className="doctor-pic">
                  <img
                    src={require("./assets/images/team-member-08.png")}
                    alt="Dr. Charlie"
                  />
                </div>
                <div className="doctor-info">
                  <h4>
                    Dr. Jessica<span>Dentist</span>
                  </h4>
                  <ul className="clearfix">
                    <li>
                      <a href="javascript:void(0);">
  ...
  {/* start screpting */}
  {/* my js */}
  {/* Mirrored from thememakker.com/templates/oreo/hospital/front/doctors.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Feb 2023 05:42:36 GMT */}
</>
