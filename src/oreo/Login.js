  ...
  <div id="wrapper" className="flex flex-col justify-between h-screen">
    ...
    <div className="bg-white py-4 shadow dark:bg-gray-800">
      <div className="max-w-6xl mx-auto">
        <div className="d-flex items-center lg:justify-between justify-around">
          <a href="trending">
            <img src={require("../oreo/assets/images/logo.png")} alt="" className="w-32" />
          </a>
          <div className="capitalize flex font-semibold lg:block my-2 space-x-3 text-center text-sm">
            <a href="login" className="py-3 px-4">
              Login
            </a>
            <a
              href="signup"
